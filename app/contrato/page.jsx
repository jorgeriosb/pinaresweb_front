    ...
    const handleChange = (e) => {
      ...
      return (
        ...
        >
          ...
          <SearchDropdown placeHolder={"Selecciona Inmueble"} records={inmueblesDisponibles} value={selectedInmueble} handleSelect={setSelectedInmueble} label1={"iden1"} label2={"iden2"} label3={"condominio"}/>
